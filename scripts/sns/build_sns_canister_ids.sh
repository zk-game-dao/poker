...
GOVERNANCE_CANISTER_ID=$(dfx -qq canister --network $DX_NETWORK id sns_governance)
INDEX_CANISTER_ID=$(dfx -qq canister --network $DX_NETWORK id sns_index)
LEDGER_CANISTER_ID=$(dfx -qq canister --network $DX_NETWORK id sns_ledger)
ROOT_CANISTER_ID=$(dfx -qq canister --network $DX_NETWORK id sns_root)
SWAP_CANISTER_ID=$(dfx -qq canister --network $DX_NETWORK id sns_swap)
